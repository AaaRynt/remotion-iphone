...
export const MagSafeCharging = () => {
  ...
  return (
    <AbsoluteFill
      ...
      style={{fontFamily: IOS_FONT, opacity: exit}}
    >
      <div
        ...
        style={{
          ...
          background:
            "radial-gradient(circle, rgba(75,255,139,0.22) 0%, rgba(47,210,112,0.08) 43%, transparent 72%)",
      ...
      >
        <div
          ...
          style={{
            ...
            background:
              "conic-gradient(from 214deg, rgba(55,220,116,0.10), rgba(76,239,137,0.96) 28%, rgba(118,255,170,0.36) 56%, rgba(46,185,98,0.08) 84%, rgba(55,220,116,0.10))",
            WebkitMask:
            ...
            boxShadow:
              "inset 0 0 20px rgba(152,255,193,0.16), 0 0 44px rgba(67,228,128,0.16)",
          }}
        />
        <LiquidGlassSurface
          className="grid place-items-center rounded-full text-center"
          style={{width: 378, height: 378, background: "rgba(10,15,13,0.72)"}}
        >
          <div className="flex flex-col items-center">
            <div className="mb-8 flex items-center gap-4 text-[#67e68f]">
              <div
                className="relative rounded-[13px] border-[5px] border-current"
                style={{width: 74, height: 38}}
              >
                <div
                  className="absolute bottom-[4px] left-[4px] top-[4px] rounded-[5px] bg-current"
                  style={{
                    width: interpolate(frame, [12, 68], [20, 52], clamp),
                  }}
                />
                <div className="absolute -right-[10px] top-[9px] h-[12px] w-[6px] rounded-r bg-current opacity-70" />
              </div>
            ...
            <div className="mt-4 text-[25px] font-medium tracking-[0.08em] text-white/48">
              CHARGING
            </div>
          </div>
        </LiquidGlassSurface>
...
const LockIcon = () => (
  <div className="relative h-[38px] w-[32px]">
    <div className="absolute left-[5px] top-0 h-[23px] w-[22px] rounded-t-full border-[5px] border-white/90" />
...
const LockScreenContent = ({localFrame}: {readonly localFrame: number}) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute left-0 right-0 top-[230px] flex flex-col items-center text-white">
        ...
        <div
          className="font-light leading-[0.88] text-white"
          style={{fontSize: 282, letterSpacing: "-0.075em"}}
        >
      ...
      <div className="absolute bottom-[128px] left-[105px] right-[105px] flex items-center justify-between">
...
const PasscodeKey = ({
  ...
  const press =
    pressFrame === undefined
      ? 0
      : interpolate(globalFrame, [pressFrame, pressFrame + 3, pressFrame + 10], [0, 1, 0], clamp);
  ...
  return (
    <LiquidGlassSurface
      ...
      style={{
        ...
        boxShadow:
          press > 0.01
            ? "inset 0 2px 14px rgba(255,255,255,0.2), 0 5px 18px rgba(0,0,0,0.12)"
            : "inset 0 1px 4px rgba(255,255,255,0.1), 0 14px 32px rgba(0,0,0,0.14)",
      }}
    >
      <span className="text-[88px] font-light leading-[0.84] tracking-[-0.04em] text-white">{digit}</span>
      {letters ? (
        <span className="mt-4 text-[24px] font-semibold tracking-[0.28em] text-white/88">{letters}</span>
      ) : null}
    </LiquidGlassSurface>
  );
};
...
const PasscodeScreenContent = ({localFrame}: {readonly localFrame: number}) => {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute left-0 right-0 top-[34px] flex justify-center"
        style={{translate: `0 ${interpolate(appearance, [0, 1], [22, 0], clamp)}px`}}
      >
        <DynamicIsland>
          <LockIcon />
        </DynamicIsland>
      ...
      <div
        className="absolute left-0 right-0 top-[410px] flex flex-col items-center text-center text-white"
        style={{translate: `0 ${interpolate(appearance, [0, 1], [64, 0], clamp)}px`}}
      >
        <div className="text-[58px] font-medium tracking-[-0.035em]">Enter Passcode</div>
        <div className="mt-5 max-w-[560px] text-[32px] font-normal leading-[1.25] text-white/72">
            ...
            return (
              <div
                ...
                style={{
                  ...
                  scale:
                    globalFrame >= event.frame && globalFrame <= event.frame + 9
                      ? interpolate(globalFrame, [event.frame, event.frame + 4, event.frame + 9], [0.7, 1.22, 1], clamp)
                      : 1,
                }}
              />
            );
      ...
      <div
        className="absolute left-[159px] right-[159px] top-[910px] grid grid-cols-3 justify-items-center gap-x-[100px] gap-y-[75px]"
        style={{translate: `0 ${interpolate(appearance, [0, 1], [110, 0], clamp)}px`}}
      >
      ...
      <div className="absolute bottom-[165px] left-[118px] right-[118px] flex justify-between text-[34px] font-medium text-white/92">
        <span>Emergency</span>
        <span>Cancel</span>
      </div>
      <HomeIndicator />
...
export const LockSequence = () => {
  ...
  return (
    <AbsoluteFill className="overflow-hidden bg-black" style={{fontFamily: IOS_FONT}}>
      <Wallpaper
        kind="lock"
        style={{
          scale: 1.012,
